...
namespace GenBase.Timer
{
    ...
    public static class TimerExtensions
    {
        ...
        public static Timer AttachTimer(
            this MonoBehaviour behaviour, string key, float duration, TimerCounting counting, Action onComplete,
            Action<float> onUpdate = null, bool isLooped = false, bool useRealTime = false)
        {
            return Timer.Register(key, duration, counting, onComplete, onUpdate, isLooped, useRealTime, behaviour);
        }
    }
}